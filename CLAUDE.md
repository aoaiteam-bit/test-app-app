...
AI-powered lead tracker for sales reps — log, score, and act on leads from a live demoable app.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "292956611+aoaiteam-bit@users.noreply.github.com"
  git config user.name "aoaiteam-bit"
  ```
